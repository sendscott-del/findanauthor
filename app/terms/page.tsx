  ...
  return (
    <div className="container" style={{ paddingTop: 56, paddingBottom: 80, maxWidth: 720 }}>
      ...
      {[
        ...
        ["Author listings", "All listed authors have been verified as traditionally published and have completed our background check process. We reserve the right to remove listings that receive negative feedback or violate our standards."],
